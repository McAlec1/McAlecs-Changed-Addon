...
import net.mcalecs.mcalecs_changed_addon.network.AddonBookGUIButtonMessage;
...
public class AddonBookGUIScreen extends AbstractContainerScreen<AddonBookGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("gui.mcalecs_changed_addon.addon_book_gui.label_i"), 105, 138, -12829636);
	}
