...
import net.mcalecs.changed_addon.client.gui.AddonBookGUIScreen;
import net.mcalecs.changed_addon.client.gui.AddonBookGUIPage1Screen;
import net.mcalecs.changed_addon.client.gui.AddonBookGUIDevTestScreen;
